...
#include "orttraining/training_ops/cuda/bert/fmha/gemm_kernel_utils.h"
...
#include "orttraining/training_ops/cuda/bert/fmha/epilogue/epilogue_pipelined.h"
#include "orttraining/training_ops/cuda/bert/fmha/iterators/epilogue_predicated_tile_iterator.h"

#include "orttraining/training_ops/cuda/bert/fmha/gemm/custom_mma.h"
#include "orttraining/training_ops/cuda/bert/fmha/gemm/find_default_mma.h"
#include "orttraining/training_ops/cuda/bert/fmha/gemm/mma_accum_lambda_iterator.h"
#include "orttraining/training_ops/cuda/bert/fmha/gemm/mma_from_smem.h"
#include "orttraining/training_ops/cuda/bert/fmha/transform/tile_smem_loader.h"
  ...
  static CUTLASS_DEVICE void attention_kernel(Params const& p) {
    ...
    if (kApplyDropout) {
      ...
      curand_init(
          p.seed_offset.first,
          0,
          p.seed_offset.second + p.dropout_batch_head_rng_offset,
          &rng_state_init);
    }
