...
if (onnxruntime_BUILD_WEBASSEMBLY)
  ...
  set_target_properties(onnxruntime_test_all PROPERTIES LINK_FLAGS "-s STACK_SIZE=4194304 -s ALLOW_MEMORY_GROWTH=1 --pre-js \"${TEST_SRC_DIR}/wasm/onnxruntime_test_all_adapter.js\" -s \"EXPORTED_RUNTIME_METHODS=['FS']\" --preload-file ${CMAKE_CURRENT_BINARY_DIR}/testdata@/testdata -s EXIT_RUNTIME=1")
  if (CMAKE_BUILD_TYPE STREQUAL "Debug")
    #set_property(TARGET onnxruntime_test_all APPEND_STRING PROPERTY LINK_FLAGS " -s STACK_OVERFLOW_CHECK=2 -s SAFE_HEAP=1 -fsanitize=address")
    set_property(TARGET onnxruntime_test_all APPEND_STRING PROPERTY LINK_FLAGS " -s STACK_OVERFLOW_CHECK=2 -s SAFE_HEAP=1")
  endif()
  if (onnxruntime_ENABLE_WEBASSEMBLY_THREADS)
