...
import numpy as np
import torch
from diffusers import DDIMScheduler, DiffusionPipeline, LMSDiscreteScheduler, PNDMScheduler
...
class StableDiffusionOnnxruntimePipeline(OnnxStableDiffusionPipeline):
    def __init__(
        self,
