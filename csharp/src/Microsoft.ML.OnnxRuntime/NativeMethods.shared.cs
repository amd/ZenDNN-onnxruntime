...
namespace Microsoft.ML.OnnxRuntime
{
    ...
    internal static class NativeMethods
    {
        ...
        // If added, SessionOptions.RegisterCustomOpsUsingFunction can be called with "OrtExtensions.RegisterCustomOps"
        // and we will handle the DllImport etc. so the user code doesn't require that.
        internal class ExtensionsNativeLib
        {
        ...
        [DllImport(ExtensionsNativeLib.ExtensionsDllName, CharSet = CharSet.Ansi, 
